          ...
          {loading ? (
            ...
            <Card className="bg-white border-gray-200 shadow-sm">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-600 mb-4">Start by scanning your first prescription</p>
            ...
            <div className="space-y-4">
              {prescriptions.map((prescription) => (
                <Card key={prescription.id} className="hover:shadow-lg transition-all cursor-pointer bg-white border-gray-200">
